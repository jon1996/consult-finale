...
// - Works for anchors and external links
// - Skips pure placeholders (href="#")
$(document).on('click', '.navbar-mobile-2 .nav-menu-items a[href]:not([href="#"])', function() {
  $(".navbar-mobile-2 .nav-menu-items").removeClass("show");
  $(".navbar-mobile-2 .hamburger-menu a").removeClass("active");
});
